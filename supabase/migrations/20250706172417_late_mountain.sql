/*
  ...
  2. Sample Data
    - 5 realistic transactions (income & expense)
    - 4 monthly budgets with categories
...
-- We'll use a more compatible approach for user creation
...
BEGIN
  ...
  RAISE NOTICE 'Admin user created successfully with email: admin@akuntansi.com';
  RAISE NOTICE 'Password: admin123';
  RAISE NOTICE 'Sample data has been inserted: % transactions, % budgets, % goals', 
...
EXCEPTION
  WHEN unique_violation THEN
    RAISE NOTICE 'Admin user already exists with email: admin@akuntansi.com';
  WHEN OTHERS THEN
