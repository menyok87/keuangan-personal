/*
  ...
  1. Database Schema
    - Buat enum types untuk debt management
    - Buat tabel debts dan debt_payments
    - Setup Row Level Security (RLS)
    - Buat policies untuk keamanan data
    - Tambah indexes untuk performa

  2. Sample Data
    - User admin dengan data hutang dan piutang
    - Berbagai status: pending, partial, paid
    - Payment history untuk yang sudah dibayar sebagian
...
BEGIN
  ...
  IF admin_user_id IS NOT NULL THEN
    -- Check if sample debts already exist (FIXED: Check after table is created)
