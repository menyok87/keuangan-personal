    ...
    return (
      <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-800 mb-2">Memuat Anggaran</h3>
          <p className="text-gray-600">Sedang mengambil data anggaran Anda...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
        <div className="text-center py-12">
          <div className="bg-red-100 rounded-xl p-6">
            <h3 className="text-lg font-medium text-red-800 mb-2">Error Memuat Anggaran</h3>
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Manajemen Anggaran</h2>
          <p className="text-gray-600">Kelola dan pantau anggaran bulanan Anda</p>
        </div>
        <button
      ...
      {budgets.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-800 mb-2">Belum ada anggaran</h3>
          <p className="text-gray-600 mb-4">Mulai kelola keuangan dengan membuat anggaran pertama Anda</p>
          <button
            onClick={() => setShowForm(true)}
