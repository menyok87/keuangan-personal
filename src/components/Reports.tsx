    ...
    <div className="space-y-8">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-4 lg:space-y-0">
          <div>
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">Laporan Keuangan</h2>
            <p className="text-gray-600 dark:text-gray-300">Analisis mendalam tentang pola keuangan Anda</p>
          </div>
        ...
        <div className="p-8">
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-6">
                  <h3 className="text-sm font-medium text-emerald-600 dark:text-emerald-400 mb-2">Total Pemasukan</h3>
                ...
                <div className="bg-red-50 dark:bg-red-900/20 rounded-xl p-6">
                  <h3 className="text-sm font-medium text-red-600 dark:text-red-400 mb-2">Total Pengeluaran</h3>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6">
                  <h3 className="text-sm font-medium text-blue-600 dark:text-blue-400 mb-2">Saldo Bersih</h3>
                  <p className={`text-2xl font-bold ${totalIncome - totalExpense >= 0 ? 'text-blue-700 dark:text-blue-300' : 'text-red-700 dark:text-red-300'}`}>
                ...
                <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-6">
                  <h3 className="text-sm font-medium text-purple-600 dark:text-purple-400 mb-2">Tingkat Tabungan</h3>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-6">
                <h3 className="text-lg font-semibold text-gray-800 dark:text-white mb-6">Tren Bulanan</h3>
                    ...
                    return (
                      <div key={index} className="space-y-2">
                        <div className="flex justify-between items-center">
                          ...
                          <span className={`text-sm font-medium ${month.net >= 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-600 dark:text-red-400'}`}>
                            {formatCurrency(month.net)}
                          </span>
                        </div>
                        <div className="space-y-1">
                          <div className="flex items-center space-x-2">
                            <div className="w-16 text-xs text-emerald-600 dark:text-emerald-400">Masuk</div>
                            ...
                            <div className="w-24 text-xs text-right text-gray-600 dark:text-gray-400">
                              {formatCurrency(month.income)}
                            </div>
                          </div>
                          <div className="flex items-center space-x-2">
                            <div className="w-16 text-xs text-red-600 dark:text-red-400">Keluar</div>
                            <div className="flex-1 bg-gray-200 dark:bg-gray-600 rounded-full h-2">
                              <div
          ...
          {reportType === 'category' && (
            <div className="space-y-6">
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Analisis per Kategori</h3>
                      ...
                      <div className="space-y-2">
                        {category.income > 0 && (
                          <div className="flex justify-between text-sm">
                            <span className="text-emerald-600 dark:text-emerald-400">Pemasukan</span>
                            <span className="font-medium text-gray-800 dark:text-white">{formatCurrency(category.income)}</span>
                          </div>
                        )}
                        {category.expense > 0 && (
                          <div className="flex justify-between text-sm">
                            <span className="text-red-600 dark:text-red-400">Pengeluaran</span>
                            <span className="font-medium text-gray-800 dark:text-white">{formatCurrency(category.expense)}</span>
                          </div>
                        )}
                      </div>
                    </div>
          ...
          {reportType === 'trend' && (
            <div className="space-y-6">
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Analisis Tren</h3>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-6">
                  <h4 className="font-medium text-gray-800 dark:text-white mb-4">Tren Pemasukan</h4>
                    ...
                    {monthlyData.map((month, index) => {
                      ...
                      return (
                        <div key={index} className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-2">
                            <span className="text-sm font-medium text-gray-800 dark:text-white">{formatCurrency(month.income)}</span>
                            {index > 0 && (
                              <span className={`text-xs px-2 py-1 rounded-full ${
                                growth >= 0 ? 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300' : 'bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300'
                              }`}>
                ...
                <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-6">
                  <h4 className="font-medium text-gray-800 dark:text-white mb-4">Tren Pengeluaran</h4>
                  <div className="space-y-3">
                    {monthlyData.map((month, index) => {
                      const prevMonth = monthlyData[index - 1];
                      ...
                      return (
                        <div key={index} className="flex items-center justify-between">
                          <span className="text-sm text-gray-600 dark:text-gray-300">{month.month}</span>
                          <div className="flex items-center space-x-2">
                            <span className="text-sm font-medium text-gray-800 dark:text-white">{formatCurrency(month.expense)}</span>
                            {index > 0 && (
                              <span className={`text-xs px-2 py-1 rounded-full ${
                                growth <= 0 ? 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300' : 'bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300'
                              }`}>
